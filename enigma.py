...
rotor1 = Rotor(pattern="I", rotation="P", ring=5)
rotor2 = Rotor(pattern="III", rotation="G", ring=3)
rotor3 = Rotor(pattern="V", rotation="Z", ring=24)
...
for plug in plug_leads.split():
    plug_board.add(PlugLead(plug))
